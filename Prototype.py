from triplesec import TripleSec #Encryption library from Keybase. TripleSec encryption protocol.
...
def FuzzyPoro():
    ...
    print ('Your recovered encrypted key is: %s' % (KeyReturn))
...
'''Uncomment this if you want to upload to IPFS
def IPFS():
    try:
